...
class FeedFoward(nn.Module):
    """ Uma simples camada linear seguida por não-linearidade """
...
class BigramLanguageModel(nn.Module):
    """ 
    O nosso modelo LLM do zero (GPT-like architecture).
    """
    def __init__(self, vocab_size):
        super().__init__()
        # Lookup table para embeddings de tokens
        self.token_embedding_table = nn.Embedding(vocab_size, Config.N_EMBD)
        # Lookup table para posição (Positional Encoding)
        self.position_embedding_table = nn.Embedding(Config.BLOCK_SIZE, Config.N_EMBD)
        
        # Blocos do Transformer
